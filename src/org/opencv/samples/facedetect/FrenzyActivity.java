...
public class FrenzyActivity extends FragmentActivity implements CvCameraViewListener2 {
       			...
       			Log.i("TotScore" , "Time of 150 sek toast in SUPER mode   "+timeStamp);
            		...
            		runOnUiThread(new Runnable() {
            			...
            			public void run() {
            				...
            				String message = "30 sekunder igjen!! "; 
        		    ...
        		    if(estimatedTime == 180){
                 	  ...
                 	  //frenzy just add points for every smile detected frame
                		winAct.putExtra("Tot_Game_Score", gameScore);
    ...
    private void openAlertStart() {
        ...
        alertDialogBuilder.setMessage("Finn flest smil pŒ 3 min...");
